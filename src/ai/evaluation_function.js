...
import { convertColourValueToString } from "../state_generation/state_generator";
...
const aggressiveMoveEvaluation = (num) => {
    let value = MAX_MARBLES / num;
    return value;
}

const centerPositionEvaluation = (position) => {
    // These are all the positions on the edge of the board.
    let bad_positions = ["i5", "i6", "i7", "i8", "i9", "h4", "h9", "g3", "g9", "f2", "f9", "e1", "e9", "d1", "d8", "c1", "c7", "b1", "b7", "a1", "a2", "a3", "a4", "a5"];
